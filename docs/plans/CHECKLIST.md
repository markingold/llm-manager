...
- [ ] Add cost-aware dynamic model ranking within a strategy (beyond fixed lane order). - effort: medium | source: docs/plans/NEXT_PUSH.md, docs/plans/retired/PROVIDER_ROUTER_PLAN.md
