...
| Direct llama.cpp backend | Implemented as the preferred GGUF lane with runtime probing, launch normalization, exact readiness identity, and a host smoke test. | Track upstream CLI compatibility through the runtime registry. | complete |
